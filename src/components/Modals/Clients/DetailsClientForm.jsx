  ...
  useEffect(() => {
    if (isDetailsModalVisible) {
      const defaultContract =
        ongoingContracts[0] || notOngoingContracts[0] || null;
      if (defaultContract) {
    ...
    <>
      ...
      >
        ...
        <Descriptions bordered style={{ marginTop: "16px" }} column={2}>
          <Descriptions.Item label="Email de contact">
            {record.email}
          </Descriptions.Item>
          <Descriptions.Item label="Email à copier en cc">
            {record.emailcc}
          </Descriptions.Item>
