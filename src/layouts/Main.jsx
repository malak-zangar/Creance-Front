...
import { FileTextOutlined,FileDoneOutlined,SettingOutlined, TeamOutlined, DollarOutlined, DashboardOutlined, UserOutlined, LogoutOutlined } from "@ant-design/icons";
...
const items = [
  ...
  },
  {
    ...
    label: <Link to="/encaissements/actif">Paiements</Link>,
  },
  {
    key: '6',
